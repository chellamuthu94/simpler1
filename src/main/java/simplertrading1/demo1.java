...
public class demo1 {
	...
	public static void zoomclick(PerformsTouchActions driver) {
		TouchAction action = new TouchAction(driver);
		
		action.tap(PointOption.point(538,1665)).release().perform();
	}
	...
	public static void unmute(PerformsTouchActions driver) {
		TouchAction action = new TouchAction(driver);
		
		action.tap(PointOption.point(281,836)).release().perform();
	}
	...
	public static WebElement option1;
			...
			@FindBy(xpath ="//android.widget.Image[@password='false']")
			public static WebElement copyclip;
			...
			@FindBy(xpath = "//android.view.View[2]/android.view.View/android.view.View[1]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.TextView[@password='false']")
			public static WebElement unmute;  
			
			

			@FindBy(xpath = "//android.view.View[3]/android.view.View/android.widget.Image")
			public static WebElement bookmarked;
            
			@FindBy(xpath = "//android.view.View[11]/android.view.View/android.widget.CheckBox/android.widget.Image")
			public static WebElement showonlybookmarked;
			
			public static void swipebookmarkedtoclick(PerformsTouchActions driver) {
